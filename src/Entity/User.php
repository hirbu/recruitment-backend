...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Posting::class, mappedBy: 'owner', orphanRemoval: true)]
    #[Groups(['user:postings'])]
    ...
    public function removePosting(Posting $posting): static
    {
        if ($this->postings->removeElement($posting)) {
            ...
            if ($posting->getOwner() === $this) {
                $posting->setOwner(null);
            }
        }
